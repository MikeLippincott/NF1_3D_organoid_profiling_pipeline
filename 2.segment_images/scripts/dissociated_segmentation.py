...
thresholded_signal_evelation_map_1 = elevation_map_1 > threshold_1
thresholded_signal_evelation_map_1 = skimage.morphology.binary_dilation(
    thresholded_signal_evelation_map_1,
...
plt.axis("off")
plt.subplot(223)
plt.imshow(elevation_map_3[cyto2.shape[0] // 2], cmap=cmap_option)
plt.title("Distance Transform")
plt.axis("off")
plt.subplot(224)
plt.imshow(elevation_map_4[cyto2.shape[0] // 2], cmap=cmap_option)
...
cyto_signal = thresholded_signal_evelation_map_1
# cyto_signal=elevation_map_2
# cyto_signal=elevation_map_3
# cyto_signal=elevation_map_4
# apply a gaussian filter
cyto_signal = sobel(cyto_signal)
cyto_signal = skimage.filters.gaussian(cyto_signal, sigma=3)
nuclei = skimage.morphology.erosion(nuclei > 0, skimage.morphology.ball(1))
...
plt.imshow(nuclei[z], cmap=cmap_option)
plt.axis("off")
plt.subplot(142)
...
plt.subplot(144)
plt.title("Cyto2 Image")
plt.imshow(cyto2[z], cmap=cmap_option)
plt.axis("off")
plt.show()
...
# remove small objects
cell_mask = skimage.morphology.remove_small_objects(cell_mask, min_size=250)
