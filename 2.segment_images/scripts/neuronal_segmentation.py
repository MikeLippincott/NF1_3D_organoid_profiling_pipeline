...
all_thresholded_signals = np.maximum(
    np.maximum(elevation_map_1_threshold_1_signal, elevation_map_2_threshold_2_signal),
    elevation_map_4_threshold_4_signal,
)
...
plt.imshow(all_thresholded_signals[z_slice_to_display], cmap=cmap_option)
plt.title("Combined Thresholded Signals")
plt.axis("off")
plt.show()
...
# cyto_signal=elevation_map_1_threshold_1_signal
cyto_signal = all_thresholded_signals
